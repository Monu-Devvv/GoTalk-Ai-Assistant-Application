    ...
    <View style={{height: hp(60)}} className='space-y-4'>
      ...
      <View className='bg-emerald-200 p-4 rounded-xl space-y-2'>
        <View className='flex-row items-center space-x-1'>
          <Image source={require('../../assests/image/chatgptIcon.png')} style={{height: hp(4), width: hp(4)}} />
        ...
        <Text style={{fontSize: wp(3.8)}} className='text-gray-700 font-medium'>
            ChatGPT can provide you with instant and knowledgeable responses, assist you with creative idea on a wide range of topics.
        </Text>
      </View>
